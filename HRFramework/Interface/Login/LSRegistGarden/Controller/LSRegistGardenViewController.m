//
//  LSRegistGardenViewController.m
//  LSZH
//
...
@interface LSRegistGardenViewController ()<LSRegistFinanceOrgnizationCellDelegate,ZYQAssetPickerControllerDelegate,UINavigationControllerDelegate>
{
    LSMyHUD *_window;
}
...
@implementation LSRegistGardenViewController
